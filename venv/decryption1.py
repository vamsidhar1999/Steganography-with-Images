...
def decrypt():
    ...
    root.config(bg="grey")
    label = Label(root, text="DECRYPTION", font=("araial", 32, "bold"), fg="black", bg="grey").grid(row=0, column=0)
    label0 = Label(root, text="CipherText :", font=("araial", 16, "bold"), fg="black", bg="grey", height=3).grid(row=5,
                                                                                                                 column=0)
    ...
    label3 = Label(root, text="Key2 :", font=("araial", 16, "bold"), fg="black", bg="grey", height=3).grid(row=11,
                                                                                                           column=0)
    label4 = Label(root, text="PlainText :", font=("araial", 16, "bold"), fg="black", bg="grey", height=3).grid(
        row=13,
        column=0)
    ...
    etciphertext = Entry(root, font=('arial', 16, 'bold'), bd=5, width=22, justify='left')
    etciphertext.grid(
        row=5, column=1)
    ...
    etkey2.grid(
        row=11, column=1)
    etptext = Entry(root, font=('arial', 16, 'bold'), bd=5, width=22, justify='left')
    etptext.grid(
        row=13, column=1)
    ...
    def decryptresult():
        ...
        etptext.delete(0, END)
        etptext.insert(0, Plain_Text)
    ...
    btnEncrpt = Button(root, text="Encrypt", padx=16, pady=16, bd=5, bg='white', fg='black', font=('arial', 10, 'bold'),
                       width=10, height=1, command=decryptresult).place(relx=0.30, rely=0.680)
